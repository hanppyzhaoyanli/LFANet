...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.double_conv = nn.Sequential(
            nn.Conv2d(in_channels, out_channels, kernel_size=3,groups=2, padding=1),
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True),
            nn.Conv2d(out_channels, out_channels, kernel_size=3,groups=2, padding=1),
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True)
        )
...
class dConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.double_conv = nn.Sequential(
            ...
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True),
            nn.Conv2d(out_channels, out_channels, kernel_size=3,groups=1, padding=1),
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True)
        )
...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=False  ):
        ...
        # self.conv = GhostBottleneck(in_channels, out_channels)
